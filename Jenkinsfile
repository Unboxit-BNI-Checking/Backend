    ...
    stages {
        ...
        stage('Run the container on port 1110') {
            steps {
                ...
                --seed.data.csv.path=data/account.csv --account.id=1 --spring.servlet.multipart.max-file-size=10MB --spring.servlet.multipart.max-request-size=10MB --spring.servlet.multipart.location=ReportAttachments" 
            }
        }
